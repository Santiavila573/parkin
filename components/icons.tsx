...
export const DietIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12a9.75 9.75 0 002.87-6.938M12 12a9.75 9.75 0 01-2.87-6.938" />
  </svg>
);
...
export const SleepIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 12c0 .354-.037.702-.11 1.043l-1.42 1.42a11.233 11.233 0 01-1.044 1.044l-1.42 1.42c-.341.073-.689.11-1.043.11-6.21 0-11.25-5.04-11.25-11.25S5.79 2.25 12 2.25c.354 0 .702.037 1.043.11l1.42 1.42c.34.34.65.708 1.044 1.044l1.42 1.42c.073.341.11.689.11 1.043z" />
